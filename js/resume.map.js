 ...
 * Don't worry, you'll learn what's going on in this file throughout the course. You won't need to make
 * any changes to it until you start experimenting with inserting a Google Map in Problem Set 3.
 *
 * Cameron Pittman
 */
...
resume.map = (function () {
    ...
    function initializeMap() {
        ...
        /*
         locationFinder() returns (via callback) an array of every location string from the JSONs
         written for bio, education, and work.
         */
        function locationFinder(callback) {
            var baseUrl = location.origin.startsWith('http')
                ? location.href + 'data/'
                : 'http://www.milanfort.com/frontend-nanodegree-resume/data/';

            $.get(baseUrl + 'bio.json', function (bio) {
                $.get(baseUrl + 'education.json', function (education) {
                    $.get(baseUrl + 'work.json', function (work) {
                        var locations = [], i;
        ...
        locationFinder(function (locations) {
